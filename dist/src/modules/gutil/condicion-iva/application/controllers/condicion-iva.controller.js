...
var CondicionIvaController_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.CondicionIvaController = void 0;
const common_1 = require("@nestjs/common");
const condicion_iva_service_1 = require("../services/condicion-iva.service");
const create_condicion_iva_dto_1 = require("../../dto/create-condicion-iva.dto");
const update_condicion_iva_dto_1 = require("../../dto/update-condicion-iva.dto");
...
const condicion_iva_dto_1 = require("../../dto/condicion-iva.dto");
...
let CondicionIvaController = CondicionIvaController_1 = class CondicionIvaController {
    constructor(service) {
        this.service = service;
        this.logger = new common_1.Logger(CondicionIvaController_1.name);
...
exports.CondicionIvaController = CondicionIvaController;
__decorate([
    (0, common_1.Post)(),
...
], CondicionIvaController.prototype, "create", null);
__decorate([
    ...
    __metadata("design:returntype", void 0)
], CondicionIvaController.prototype, "findByDenominacionFiltered", null);
__decorate([
    ...
    __metadata("design:returntype", void 0)
], CondicionIvaController.prototype, "findAllFor", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, roles_decorator_1.Roles)('Root', 'Administrador', 'Empleado'),
    (0, swagger_1.ApiOkResponse)({ type: condicion_iva_dto_1.CondicionIvaDto }),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
], CondicionIvaController.prototype, "findOne", null);
__decorate([
    (0, common_1.Put)(':id'),
    (0, roles_decorator_1.Roles)('Root'),
    (0, common_1.UsePipes)(normalize_denominations_pipe_1.NormalizeDenominacionPipe),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, update_condicion_iva_dto_1.UpdateCondicionIvaDto]),
    __metadata("design:returntype", void 0)
], CondicionIvaController.prototype, "update", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", void 0)
], CondicionIvaController.prototype, "remove", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
], CondicionIvaController.prototype, "findByIdConAuditoria", null);
exports.CondicionIvaController = CondicionIvaController = CondicionIvaController_1 = __decorate([
    (0, swagger_1.ApiTags)('GUtil'),
    (0, common_1.Controller)('condicion-iva'),
    (0, common_1.UseGuards)(auth_guard_1.AuthGuard),
    __metadata("design:paramtypes", [condicion_iva_service_1.CondicionIvaService])
], CondicionIvaController);
//# sourceMappingURL=condicion-iva.controller.js.map