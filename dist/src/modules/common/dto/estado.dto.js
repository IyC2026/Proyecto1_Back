...
class EstadoDto {
    constructor(codigo, denominacion) {
        this.codigo = codigo;
...
__decorate([
    ...
    (0, class_validator_1.IsNotEmpty)({ message: 'El codigo es obligatorio.' }),
    (0, class_validator_1.IsInt)({ message: 'El codigo debe ser un número entero.' }),
    __metadata("design:type", Number)
], EstadoDto.prototype, "codigo", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({
...
], EstadoDto.prototype, "denominacion", void 0);
