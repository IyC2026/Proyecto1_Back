...
export interface IConfiguracionSistemaRepository {
    ...
    update(id: number, data: UpdateConfiguracionSistemaDto): Promise<ConfiguracionSistema>;
    remove(data: ConfiguracionSistema, usuario: Usuario): Promise<ConfiguracionSistema>;
}
