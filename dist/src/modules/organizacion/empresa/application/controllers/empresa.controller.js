...
let EmpresaController = EmpresaController_1 = class EmpresaController {
    constructor(service) {
        this.service = service;
        this.logger = new common_1.Logger(EmpresaController_1.name);
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], EmpresaController.prototype, "findByDenominacionFiltered", null);
__decorate([
    (0, common_1.Get)(':id'),
...
exports.EmpresaController = EmpresaController = EmpresaController_1 = __decorate([
